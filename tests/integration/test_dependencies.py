...
def test_cur_usr_ok(mock_verify_token):
...
def test_cur_usr_bad_tok(mock_verify_token):
...
def test_cur_usr_bad_payload(mock_verify_token):
...
def test_active_usr_ok(mock_verify_token):
    mock_verify_token.return_value = sample_user_data
...
def test_active_usr_inactive(mock_verify_token):
