...
def test_mk_usr_fake(db_session):
    """
...
def test_mk_many_users(db_session):
    """
...
def test_update_refresh(db_session, test_user):
    """
...
def test_unique_usr(db_session):
    """
...
def test_usr_persist_after_err(db_session):
    """
